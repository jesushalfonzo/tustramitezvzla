...
//SQL Compras
$SQL="SELECT m_venta_id FROM m_ventas WHERE m_venta_idCliente='$idusuario'";
$querycomp=mysqli_query($link, $SQL);
$numeroCompras=mysqli_num_rows($querycomp);
...
<div class="container" id="menumobile">
    <nav id="menu" role="navigation">
        <ul>
            ...
            <li><a href="#" class="lnk-menu num-compras">Compras</a></li>
...
<section class="container-fluid">
    <div class="container menuAdmin">
        <div class="col-md-12 menu">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="compras" href="#">Compras</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row" id="resumen-details">
            <div class="col-md-12 text-admin">
                ...
                <hr>
                <a href="#" class="num-compras"><button type="button" class="btn btn-secondary"><?=$numeroCompras?></button> Compras</a>
                <hr>
            </div>
        </div>
        ...
        <div class="row text-admin" id="solicitudes-details" style="display: none;" >
            ...
            while ($rowSolicitudes=mysqli_fetch_array($querySolicitudes)) {
                ...
                if (($m_solicitud_estatus_id ==1) or ($m_solicitud_estatus_id ==6) or($m_solicitud_estatus_id ==7)) {
                   $porcentajeAvance=0;
               } else {
            ...
            <div class="col-md-12 tableAdmin text-center col-sm-12">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="text-admin"><a href="internal_service.php?id=<?=$m_servicio_id?>"> <?=$m_servicio_nombre?> </a></div>
                </div>
        ...
        <div class="row text-admin" id="compras-details" style="display: none;" >
            <h4>Compras</h4>
            <div class="col-md-12 text-center col-sm-12">
                <div class="col-md-1 col-sm-1">#</div>
                <div class="col-md-2 col-sm-2">Producto</div>
                <div class="col-md-2 col-sm-2">Cantidad</div>
                <div class="col-md-2 col-sm-2">Precio</div>
                <div class="col-md-2 col-sm-2">Total compra</div>
                <div class="col-md-2 col-sm-2 col-md-offset-1">Estatus</div>
            </div>
            <!-- Solicitudes -->
            <?php 
            $SQLVentas="SELECT m_venta_id, m_venta_estatus, m_venta_cantidad, m_venta_idProducto, m_venta_idCliente, m_producto_nombre, m_producto_precio, m_producto_id FROM m_ventas AS V, m_productos AS P WHERE V.m_venta_idCliente='$idusuario' AND P.m_producto_id=V.m_venta_idProducto";
            $queryVentas=mysqli_query($link, $SQLVentas);
            while ($rowVentas=mysqli_fetch_array($queryVentas)) {
                $m_venta_id=$rowVentas["m_venta_id"];
                $m_venta_estatus=$rowVentas["m_venta_estatus"];
                $m_venta_cantidad=$rowVentas["m_venta_cantidad"];
                $m_venta_idProducto=$rowVentas["m_venta_idProducto"];
                $m_venta_idCliente=$rowVentas["m_venta_idCliente"];
                $m_producto_nombre =$rowVentas["m_producto_nombre"];
                $m_producto_precio=$rowVentas["m_producto_precio"];
                $m_producto_id=$rowVentas["m_producto_id"];

            switch ($m_venta_estatus) {
                case 0:
                $tipoBoton = "default";
                $textoVenta="Esperando Aprobaci&oacute;n";
                break;
                case 1:
                $tipoBoton =  "primary";
                $textoVenta="Aprobado";
            ...
            <div class="col-md-12 tableAdmin text-center col-sm-12">
                <div class="col-md-1 col-sm-1">
                    <blockquote class="card-blockquote"> 00<?=$m_venta_id?></blockquote>
                </div>
                <div class="col-md-2 col-sm-2">
                    <div class="text-admin"><a href="internal_shop.php?id=<?=$m_producto_id?>"> <?=$m_producto_nombre?> </a></div>
                </div>
                <div class="col-md-2 col-sm-2">
                    <div class="text-admin"><a href="internal_shop.php?id=<?=$m_producto_id?>"> <?=$m_venta_cantidad?> </a></div>
                </div>
                <div class="col-md-2 col-sm-2">
                    <div class="text-admin"><a href="internal_shop.php?id=<?=$m_producto_id?>">€ <?=$m_producto_precio?> </a></div>
                </div>
                 <div class="col-md-2 col-sm-2">
                    <div class="text-admin"><a href="internal_shop.php?id=<?=$m_producto_id?>">€ <?=number_format($m_producto_precio*$m_venta_cantidad,2,'.','')?> </a></div>
                </div>
                <div class="col-md-2 col-sm-2">
                    <button type="button" class="btn btn-<?=$tipoBoton?>"><?=utf8_encode($textoVenta)?></button>
                </div>
            </div>
 ...
 <div class="container cnt-banner">
    <div class="col-md-8 col-md-offset-1 col-xs-12"><img src="image/banner728x90.png" alt=""></div>
</div>
...
$( "#compras,.num-compras" ).click(function() {
  $( "#compras-details" ).show( "slow" );
