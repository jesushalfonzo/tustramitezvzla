    ...
    <div class="slide" id="slide5" data-slide="5" data-stellar-background-ratio="0.5">
        <div class="container clearfix">
            ...
            <div class="row">
                ...
                <div class="content grid_12 contactmap dn" id="contact-car" style="height:100%;">
                    <div class="col-xs-12 col-md-4">
                        <h2>ESCRÍBENOS A NUESTRO CORREO</h2>
                        <p id="info-correo">tustramitesweb@gmail.com</p>
                        <br><br>
                    </div>
                    <div class="grid_8 omega">
                        <form name="contactenos" id="contactenos">
...
submitHandler: function(form) {
   var formData = new FormData($("#contactenos")[0]);
   $.ajax({
