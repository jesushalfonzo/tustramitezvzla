...
<div class="modal fade" id="comprar" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form name="compraFinal" id="compraFinal">
                <input type="hidden" name="idProducto" id="idProducto" value="<?=$idProducto?>">
                <input type="hidden" name="idCliente" id="idCliente" value="<?=$idusuario?>">

                <div class="modal-body">
                    <div class="row text-left">
                        <div class="col-xs-12 tableAdmin text-center">
                            <div class="col-xs-4"><strong>Producto:</strong></div>
                            <div class="col-xs-2"><strong>Cantidad:</strong></div>
                            <div class="col-xs-3"><strong><i class="fa fa-money" aria-hidden="true"></i> Precio c/u:</strong></div>
                            <div class="col-xs-3"><strong><i class="fa fa-slack" aria-hidden="true"></i> Total:</strong></div>
                        </div>
                        <div class="col-xs-12">
                            <div class="col-xs-4"><?=$m_producto_nombre?></div>
                            <div class="col-xs-2 text-center"><input type="text" name="cantidadFinal" id="cantidadFinal" readonly="yes" value="" class="sinBordes"></div>
                            <div class="col-xs-3 text-center"><?=$m_producto_precio?> <i class="fa fa-eur" aria-hidden="true"></i></div>
                            <div class="col-xs-3 text-center" id="pagar"><i class="fa fa-eur" aria-hidden="true"></i></div>
                        </div>
                    </div>   
        ...
        <div class="row">
                ...
                <div class="col-md-5 cont-product-title">
                    ...
                    <ul>
                        ...
                        <li><br>
                            ...
                            <button type="button" class="btn-rg btn btn-default" data-toggle="modal" id="comprando" data-target="#comprar"><i class="fa fa-cart-plus" aria-hidden="true"></i> Comprar</button>
                            <?php } else { ?>
            ...
            $(document).ready(function(){
                $('#comprando').click(function(){
                    ...
                    var pagar = <?=$precioFinal?>*cantidad;
                    $("#pagar").html("‎€ "+ pagar);
                }); 
            });
...
$(document).ready(function(){
    ...
    $('#confirmar').click(function(){
        ...
        $("#confirmar").html('confirmando...');
        $("#confirmar").prop('disabled', true);

        var formData = new FormData($("#compraFinal")[0]);
        setTimeout(function(){
            $.ajax({
                url: "process/procesarCompra.php",
                type: 'POST',
                ...
                success: function (data) {
                    if (data['success']) {
                        ...
                        setTimeout(function() { $(".alert").alert('close'); $("#mensajesx").css("z-index", "-1");}, 4000);
                        setTimeout("location.href='myaccount.php';", 2000);
                    } else{
                        $("#mensajesx").css("z-index", "999");
