                      ...
                      <div class="x_content">
                        ...
                        <form action="" method="post" id="register-form" class="form-horizontal form-label-left" novalidate="novalidate">
                         <div id="mensajes" class="alert alert-info" role="alert" style="display: none;"></div>
                          ...
                          <input type="hidden" name="idevento" class="form-control has-feedback-left" id="idevento" value="<?=$e_id?>">
                             <input type="text" name="date" class="form-control has-feedback-left" id="date" value="<?=$e_date?>" Readonly>
                             <span class="fa fa-calendar  form-control-feedback left" aria-hidden="true"></span>
                           </div>
                         </div>
                         <div class="form-group">
                         <div class="col-md-5 col-sm-6 col-xs-12 col-md-offset-2">
                            <input type="text" class="form-control has-feedback-left" name="title" id="title" value="<?=$e_titulo?>">
                            <span class="fa fa-text-height form-control-feedback left" aria-hidden="true"></span>
                          </div>
                        </div> 
                        <div class="form-group">
                        <div class="col-md-5 col-sm-6 col-xs-12 col-md-offset-2">
                            <textarea name="description" id="description" class="form-control has-feedback-left" id="" cols="30" rows="10" placeholder="Description"><?=$e_description?></textarea>
                            <span class="fa fa-pencil form-control-feedback left" aria-hidden="true"></span>
                          </div>
                        </div>    
                        <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-6">
                            <button id="registro-btn" type="submit" class="btn btn-danger">Actualizar</button>
                          </div>
                        </div>   
                      </form>
                    </div>
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data['success']) {
            ...
            var urlredirect = "editar.php";
            setTimeout(function() {  $('#mensajes').fadeOut(1); $("#mensajes").css("z-index", "-1"); window.location.replace(urlredirect);}, 2000);
