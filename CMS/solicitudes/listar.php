...
if (($cantidadResultados=="") and ($estatus=="")) {
 ...
 if ($cantidadResultados!="") {
   $SQL.=" ORDER BY m_servicio_id LIMIT 0,$cantidadResultados";
 }
}
...
if((isset($_GET["idServicio"]))&&($_GET["idServicio"]!="")){ 
 ...
 $SQL="SELECT * FROM m_solicitudes, m_clientes, m_servicios, m_estatus_solicitudes WHERE m_solicitud_idServicio='$idServicio' AND m_solicitud_idCliente=m_cliente_id AND m_solicitud_idServicio=m_servicio_id AND m_solicitud_estatus_id= m_estatus_solicitud_id ORDER BY  m_solicitud_estatus_id DESC, m_solicitud_fechaCreacion ASC LIMIT 0,20";
  }
